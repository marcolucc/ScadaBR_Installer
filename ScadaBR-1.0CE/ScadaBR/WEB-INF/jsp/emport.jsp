  ...
  <script type="text/javascript">
    ...
    function doExportJson() {
        ...
        EmportDwr.createExportData($get("prettyIndent"), $get("graphicalViews"), $get("eventHandlers"),
                ...
                $get("watchLists"), $get("maintenanceEvents"),$get("scripts"),$get("pointValues"),$get("pointValuesMax"),$get("systemSettings"), function(data) {
            $set("emportData", data);
    ...
    <table width="100%">
      ...
      <tr>
        <td class="formField" style="padding-left:50px;">
          ...
          <input type="checkbox" id="dataPoints" onchange="dataPointsCheckboxChanged();"/> <label for="dataPoints"><fmt:message key="emport.dataPoints"/></label><br/>
           - <input type="checkbox" id="pointValues"/> <label for="pointValues"><fmt:message key="emport.pointValues"/></label><br/>
        ...
        <td>
          ...
          <input type="checkbox" id="scripts"/> <label for="scripts"><fmt:message key="header.scripts"/></label><br/>
          <input type="checkbox" id="systemSettings"/> <label for="scripts"><fmt:message key="header.systemSettings"/></label><br/>
...
<!--          <input type="checkbox" id="dynamicImages"/> <label for="dynamicImages"><fmt:message key="header.dynamicImages"/></label><br/>-->
      ...
      <tr>
        <td class="formLabelRequired"><fmt:message key="emport.pointValuesMax"/></td>
        <td>
	        <select id="pointValuesMax">
      ...
      <tr>
        <td colspan="2" align="center">
          <input id="exportJsonBtn" type="button" value="<fmt:message key="emport.exportJson"/>" onclick="doExportJson()"/>
  ...
  <div class="borderDiv marB" style="float:left;">
    <table width="100%">
      <tr>
      	<td>
      		<span class="smallTitle"><fmt:message key="emport.exportProjectTitle"/></span>
      		<tag:help id="exportProject"/>
      	</td>
      </tr>
      
      <tr> 
        <td>
          <label for="projectName"><fmt:message key="emport.projectName"/></label>
          <input type="text" id="projectName" value="${instanceDescription}"/><br/>
        </td>
        
      </tr>
      <tr>
      	<td>
      		<label for="projectDescription"><fmt:message key="emport.projectDescription"/></label><br/>
      		<textarea id="projectDescription" rows="4" cols="50"></textarea> 
      	</td>
      </tr>
      <tr> 
        <td>
          <input type="checkbox" id="includePointValues"/> <label for="includePointValues"><fmt:message key="emport.includePointValues"/></label><br/>
          <input type="checkbox" id="includeUploadsFolder"/> <label for="includeUploadsFolder"><fmt:message key="emport.uploadsFolder"/></label><br/>
          <input type="checkbox" id="includeGraphicsFolder"/> <label for="includeGraphicsFolder"><fmt:message key="emport.graphicsFolder"/></label><br/>
        </td>
      ...
      <tr>
       <td>
          <label for="pointValuesMaxZip"><fmt:message key="emport.pointValuesMax"/></label>
          <select id="pointValuesMaxZip">
	          <option value="100"/>100</option>
	          <option value="500"/>500</option>
	          <option value="1000"/>1000</option>
	          <option value="10000"/>10000</option>
      ...
      <tr>
        <td>
          <fmt:message key="emport.exportProjectInstruction"/>
          <input id="exportBtn" type="button" value="<fmt:message key="emport.exportProject"/>" onclick="doExport()"/>
        </td>
      </tr>
      <tbody></tbody>
      <tr><td></td></tr>
  ...
  <div class="borderDiv marB" style="float:left;">
    <form method="POST" action="import_project.htm" enctype="multipart/form-data" onsubmit="return checkFileToImport();">
    <table width="100%">
      <tr>
      	<td>
      ...
      <tr>
        <td>
          <fmt:message key="emport.importProjectInstruction"/>
        </td>
      </tr>
      ...
      <tr>
        <td>
          ...
          <input id="importBtn" type="submit" value="<fmt:message key="emport.send"/>"/>  
        </td>
      </tr>
    ...
    <table width="100%">
      ...
      <tr>
        <td>
          ...
          <input id="importJsonBtn" type="button" value="<fmt:message key="emport.import"/>" onclick="doImport()"/>
