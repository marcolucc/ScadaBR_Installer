  ...
  <script type="text/javascript">
    function StaticEditor() {
        ...
        this.open = function(compId) {
            ...
            ViewDwr.getViewComponent(compId, function(comp) {
				...
				if(comp.defName == 'html') {
		            ...
		            show("staticEditorPopup");
				} else if(comp.defName == 'flexBuilder'){
        ...
        this.save = function() {
			...
			} else if(staticEditor.component.defName == 'flexBuilder') {
				ViewDwr.saveFlexBuilderComponent(staticEditor.componentId, $get("flexWidth"), $get("flexHeight"),
					...
					function(response) {
						if (response.hasMessages)
							...
							staticEditor.close();
			                tempContent = "<div style='background-color: silver; border: 1px solid red; width: "+ $get("flexWidth") +"px; height: "+$get("flexHeight") +"px;'> <b> <fmt:message key='viewEdit.graphic.saveToLoad'/> </b> </div>";
