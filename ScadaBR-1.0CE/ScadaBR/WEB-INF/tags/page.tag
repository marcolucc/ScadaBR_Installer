...
<head>
  ...
  <meta name="Copyright" content="ScadaBR &copy;�2009-2011 Funda��o Certi, MCA Sistemas, Unis Sistemas, Conetec, Todos os direitos reservados."/>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" id="mainHeader">
  <tr>
    <td><img src="https://cdn-gijcn.nitrocdn.com/bCQWeNyzIIOWrbCOmaEFJmjoUbJtLRIo/assets/images/optimized/rev-f3ad4a3/wp-content/uploads/2022/05/logo_relatech_your_desk_for_innovation_white.svg" alt="Logo"/></td>
    <c:if test="${!simple}">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    <td colspan="2" class="footer" align="center">&copy;2022 Relatech S.p.A. P.IVA 03267710964 | Based on ScadaBR - 1.0 CE GPL 3 <fmt:message key="footer.rightsReserved"/></td>
  </tr>
</table>
